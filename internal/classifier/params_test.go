...
func TestComputeParams_PatternDrivenForecaster(t *testing.T) {
	...
	f := classifier.Features{CV: 0.1, TodCorrelation: 0.8, TrendSlope: 3.0, PeakToTrough: 2.0}
...
func TestComputeParams_UnknownPatternFallsBackToLinearExtrap(t *testing.T) {
	f := classifier.Features{CV: 0.1, TodCorrelation: 0.5, TrendSlope: 0.1, PeakToTrough: 2.0}
